...
namespace ANZHFR.Web.Controllers
{
    ...
    public class HomeController : BaseController
    {
        ...
        public JsonResult Dashboard_Refresh()
        {
            ...
            var patientFilter = "";
            if (patientTypes.IndexOf("ED") != -1) patientFilter = "PatientType = '1'";


            var patients = _patientServices.GetDashboard(hospitalId, patientTypes, period);
            ...
            int midList;
            var EDPatients = patients.Where(item => item.AdmissionViaED == "1").ToList();
            ...
            var AcuteLOSPatients = patients.Where(item => item.WardDischargeDate != null).ToList();
            ...
            var HospitalLOSPatients = patients.Where(item => item.HospitalDischargeDate != null).ToList();
            ...
            var CareAtPresentationPatients = patients.Where(item => item.CognitiveState != null).ToList();
            if (CareAtPresentationPatients.Count() > 0 )
            {
                CareAtPresentation = (CareAtPresentationPatients.Where(item => item.CognitiveState == "1").Count() * 100 / CareAtPresentationPatients.Count()).ToString("0") + "%";
            }
            else
            {
                CareAtPresentation = "-";
            ...
            {
                GeriatricAssessment = (GeriatricAssessmentPatients.Where(item => item.GeriatricAssessment == "2").Count() * 100 / GeriatricAssessmentPatients.Count()).ToString("0") + "%";
            }
            else
            {
                GeriatricAssessment = "-";
            ...
            {
                Mobilisation = (MobilisationPatients.Where(item => item.Mobilisation == "1").Count() * 100 / MobilisationPatients.Count()).ToString("0") + "%";
            }
            else
            {
                Mobilisation = "-";
            ...
            if (MobilisationPatients.Count() > 0)
            {
                WeightBearing = (WeightBearingPatients.Where(item => item.FullWeightBear == "1").Count() * 100 / WeightBearingPatients.Count()).ToString("0") + "%";
            }
            else
            {
                WeightBearing = "-";
            ...
            {
                PressureUlcers = (PressureUlcerPatients.Where(item => item.PressureUlcers == "2").Count() * 100 / PressureUlcerPatients.Count()).ToString("0") + "%";
            }
            else
            {
                PressureUlcers = "-";
            ...
            {
                DischargeBoneMedication = (DischargeBoneMedicationPatients.Where(item => item.BoneMedDischarge == "2" || item.BoneMedDischarge == "3").Count() * 100 / DischargeBoneMedicationPatients.Count()).ToString("0") + "%";
            }
            else
            {
            ...
            {
                FallsAssessment = (FallsAssessmentPatients.Where(item => item.FallsAssessment == "2").Count() * 100 / FallsAssessmentPatients.Count()).ToString("0") + "%";
            }
            else
            {
                FallsAssessment = "-";
